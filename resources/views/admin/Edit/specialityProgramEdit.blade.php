...
@section('title','Editar Especialidades Glosa')
@section('active-ingresardatos','active')

@section('content')
<h1>Editar Especialidades Glosa</h1>
<div class="div-full">
	@if ($errors->any())
	...
	@if ($speciality)
	<form method="post" action="{{ url('especialidad-glosa/edit') }}">
		@csrf
		...
		<div class="form-group">
			<input type="text" class="form-control {{ $errors->has('codigo') ? ' is-invalid' : '' }}" value="{{$speciality->codigo}}" placeholder="{{$speciality->codigo}}" id="codigo" name="codigo">
		</div>
