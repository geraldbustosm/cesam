...
<div class="div-full">
    ...
    @endif
    <form method="post" action="{{ url('registrar/atributos') }}">
        @csrf
        <div class="form-group">
            <div class="form-row">
                <div class="col-6">
                    <input type="text" class="form-control {{ $errors->has('attribute') ? ' is-invalid' : '' }}" value="{{ old('attribute') }}" id="attribute" name="attribute" placeholder="Atributo del paciente">
                    <br>
                    ...
                    <div class="">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th style="width: 3%;">#</th>
                                    <th style="width: 70%;">Atributos</th>
